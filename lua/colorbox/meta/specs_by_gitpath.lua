return {
  ...
  ["everviolet-nvim"] = {
    handle = "everviolet/nvim",
    url = "https://github.com/everviolet/nvim",
    github_stars = 509,
    last_git_commit = "2025-09-18",
    priority = 0,
    source = "vsc",
    git_path = "everviolet-nvim",
    git_branch = nil,
    color_names = {
      "evergarden",
      "evergarden-fall",
