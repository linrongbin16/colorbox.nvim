...
describe("colorbox.db", function()
  ...
  describe("[get_xxx]", function()
    ...
    it("get_specs_by_install_path", function()
      local specs_by_install_path = db.get_specs_by_install_path()
      assert_eq(type(specs_by_install_path), "table")
    end)
    ...
    it("get_color_names_list", function()
      local ColorNamesList = db.get_color_names()
